...
export default function Onboarding({ userId, onComplete }: OnboardingProps) {
  ...
  const slides = [
    {
      icon: Target,
      title: 'Welcome to FinancePlan',
      description: 'Your personal assistant for achieving financial goals',
      content: 'We will help you build a secure financial future through systematic planning and intelligent analysis.',
      gradient: 'from-emerald-500 to-teal-500',
    },
    {
      icon: TrendingUp,
      title: 'Why is financial planning important?',
      description: 'Financial planning is the key to stability',
      content: 'Without a clear plan, 78% of people fail to achieve their financial goals. Planning helps control expenses, increase savings, and protect against unexpected situations.',
    ...
    },
    {
      ...
      content: 'Our algorithms analyze your income, expenses, and goals to offer the optimal strategy for achieving financial independence.',
      gradient: 'from-violet-500 to-fuchsia-500',
    },
    {
      icon: DollarSign,
      title: 'Choose your currency',
      description: 'Which currency will you use for accounting?',
      content: 'Choose the main currency for displaying all financial data. You can change this later in settings.',

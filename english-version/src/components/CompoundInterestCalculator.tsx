    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-slate-600">
          Calculate investment returns with reinvestment and regular contributions
        </p>
      </div>
          ...
          <div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <p className="text-sm text-slate-600 mb-1">Final Amount</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                  ...
                  <div className="flex items-center justify-center">
                    <PieChartComponent
                      data={[
                        { label: 'Initial Amount', value: result.initialPrincipal, color: '#3b82f6' },
                        { label: 'Income', value: result.totalInterest, color: '#10b981' },
                        { label: 'Contributions', value: result.totalContributions, color: '#f97316' },
                      ]}
                      currency={currency}
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm text-slate-600">Initial Amount</p>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b-2 border-slate-200 bg-slate-50">
                        ...
                        <th className="text-right py-3 px-4 font-semibold text-slate-700">Initial Amount</th>
                        <th className="text-right py-3 px-4 font-semibold text-slate-700">Interest Income</th>
                        <th className="text-right py-3 px-4 font-semibold text-slate-700">Contributions</th>
                        <th className="text-right py-3 px-4 font-semibold text-slate-700">Final Amount</th>
                      </tr>
                    </thead>
                    <tbody>
                      {(() => {

  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden sm:inline text-sm font-semibold tracking-wide">Валюта</span>
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-amber-500 to-orange-500 p-8 sm:p-12 text-white">
                ...
                <p className="text-base sm:text-lg text-center text-white/90">
                  Все финансовые данные будут отображаться в выбранной валюте
                </p>
              </div>
              ...
              <div className="p-6 sm:p-8">
                <div className="mb-4">
                  <p className="text-sm text-slate-600">
                    Текущая валюта: <span className="font-bold text-slate-900">{CURRENCIES.find(c => c.code === currency)?.name} ({getCurrencySymbol(currency)})</span>
                  </p>
                </div>
